...
} from "./connectionIconRegistry";

interface ConnectionIconPickerProps {
  value?: ConnectionIconRef;
  onSelect: (icon: ConnectionIconRef) => void;
  onClear: () => void;
  onBack?: () => void;
}

export default function ConnectionIconPicker({
  value,
  onSelect,
  onClear,
  onBack,
}: ConnectionIconPickerProps) {
  ...
  return (
    <div className="min-w-0">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-xs text-dark-muted flex-1">Assign icon</span>
        {value && (
          <button
            type="button"
            onClick={onClear}
