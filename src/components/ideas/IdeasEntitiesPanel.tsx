const PLACEHOLDER_ENTITIES = ["Idea A", "Bubble b1", "Concept X"];

export default function IdeasEntitiesPanel() {
  return (
    <div className="w-[260px] flex-shrink-0 border-r border-dark-accent/50 bg-dark-surface flex flex-col overflow-hidden">
      <div className="p-4 border-b border-dark-accent/50">
        ...
        <p className="text-dark-muted text-xs mt-1">Idea entities (stub)</p>
      </div>
